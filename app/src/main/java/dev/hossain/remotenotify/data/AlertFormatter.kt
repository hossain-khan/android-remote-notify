...
class AlertFormatter
    ...
    constructor() {
        ...
        private fun formatDeviceAlert(deviceAlert: DeviceAlert, formatType: FormatType): String {
        ...
        private fun formatPluginAlert(pluginAlert: RemoteAlert.PluginAlert, formatType: FormatType): String {
            return when (formatType) {
        ...
        private fun formatPluginAlertHtml(alert: RemoteAlert.PluginAlert): String {
            return """
                ...
                <strong>Timestamp:</strong> ${java.text.SimpleDateFormat("yyyy-MM-dd HH:mm:ss", java.util.Locale.getDefault()).format(java.util.Date())}
                </small></p>
                </body>
                </html>
            """.trimIndent()
